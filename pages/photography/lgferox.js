...
const images = [1, 2, 2, 1, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2, 1, 2, 2, 2, 2] // sizes;
const title = 'Lunar Gala: Ferox'
const date = 'February 2018'
const base_url = '/images/lgferox/';

export default function Lgferox() {
