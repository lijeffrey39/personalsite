...
const images = [1, 2, 2, 2, 2, 1, 2, 2, 1, 2, 2] // sizes;
const title = 'Lunar Gala: Sonder'
const date = 'February 2017'
const base_url = '/images/lgsonder/';

export default function Lgsonder() {
